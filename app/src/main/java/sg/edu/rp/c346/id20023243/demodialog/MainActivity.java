package sg.edu.rp.c346.id20023243.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                ...
                //positive means expect user to click it
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //inflate input2.xml layout file
                LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View viewDialog = inflater.inflate(R.layout.input2, null);

                final EditText etNum1 = viewDialog.findViewById(R.id.editTextNum1); //to get contents of input2
                final EditText etNum2 = viewDialog.findViewById(R.id.editTextNum2);

                AlertDialog.Builder myBuilder = new AlertDialog.Builder(MainActivity.this);
                myBuilder.setView(viewDialog); //so that whatever inside input 2 is inside alert dialog
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        int total = num1 + num2;
                        //setting text
                        tvSum.setText("The sum is " + total);
                    }
                });
                myBuilder.setNegativeButton("CANCEL", null);
                AlertDialog myDialog = myBuilder.create();
        ...
        btnDemo4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Create date picker dialog to show current date when it first appears
            ...
            public void onClick(View v) {
                TimePickerDialog.OnTimeSetListener myTimeListener = new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        tvDemo5.setText("Time " + hourOfDay + ":" +minute); //minute can format to 2 numbers using string.format
                    }
                };

                //create time picker dialog 24hr
